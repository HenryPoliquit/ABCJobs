...
<main class="bg2 align-center flex-col">
	...
	<h2 class="dashboard-heading hFont">Post Detail</h2>
	<div class="flex dashboard">
		...
		<div class="flex-col gap-20">
			...
			<sf:form id="createCommentForm" class="align-center flex-col form"
				onsubmit="validateCreateComment(event)" action="create_post_comment"
				method="post" modelAttribute="comment">
				<div class="input-group">
				<c:forEach items="${post}" var="r">
					<input required="true" type="hidden" name="postId"
						path="postId" autocomplete="off" value="${r.getId()}" />
				</c:forEach>
			...
			<!-- Comments -->
			<sec:authorize access="hasRole('Users')">
			<c:forEach items="${uComment}" var="c">
