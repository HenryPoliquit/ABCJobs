...
<main class="bg2 align-center flex-col">
	...
	<div class="flex dashboard">
		...
		<div class="flex-col gap-20">
						...
						<tr>
							...
							<td>
								<div class="flex center gap-10">
									<!-- Update -->
									<button id="createPost" class="btnAnimation material-icons">edit</button>
			<!-- Post Modal -->
			...
			<h3 class="modal-heading">Edit Post</h3>
			<sf:form id="createPostForm" class="align-center flex-col form"
				onsubmit="validateCreatePost(event)" action="edit_post?pId=${p.id}"
				...
				<div class="input-group">
					<input required="true" type="text" name="name" path="name"
						...
						onkeyup="validateFullname()" value="${p.name}" /> <label class="user-label">Name</label>
				</div>
				<div class="input-group">
			...
			<dialog id="deleteModal" class="modal">
				<h3 class="modal-heading">Delete Post</h3>
				<a href="/delete_post?pId=${p.id}"><button class="submit-btn btnAnimation" style="background-color: var(--error);" type="submit">Delete</button></a>
